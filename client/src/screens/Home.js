...
const Home = () => {
  ...
  const likePost = (id) => {
    axios
      .put(
        `https://instagram-clone-qrc9.onrender.com/like`,
        { postId: id },
        config
      )
      .then((result) => {
  ...
  const unlikePost = (id) => {
    axios
      .put(
        `https://instagram-clone-qrc9.onrender.com/Unlike`,
        { postId: id },
        config
      )
      .then((res) => {
  ...
  const bookmark = (id) => {
    axios
      .put(
        `https://instagram-clone-qrc9.onrender.com/bookmark-post`,
        { postId: id },
        config
      )
      .then((result) => {
  ...
  const removeBookmark = (id) => {
    axios
      .put(
        `https://instagram-clone-qrc9.onrender.com/remove-bookmark`,
        { postId: id },
        config
      )
      .then((result) => {
  ...
  const makeComment = (text, postId) => {
    ...
    axios
      .put(
        `https://instagram-clone-qrc9.onrender.com/comment`,
        { text, postId },
        config
      )
      .then((result) => {
  ...
  const deletePost = (postId) => {
    axios
      .delete(
        `https://instagram-clone-qrc9.onrender.com/deletepost/${postId}`,
        config
      )
      .then((res) => {
